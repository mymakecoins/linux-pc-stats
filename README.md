# linux-pc-stats (Status Bar Utility)

Aplicação modular em Python que exibe telemetria do sistema (CPU, RAM, bateria, disco, GPU) e previsão do tempo na barra de status de ambientes de desktop Linux (barra do sistema, Polybar, Waybar).
